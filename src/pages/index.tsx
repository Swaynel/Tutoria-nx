...
export default function Home() {
  ...
  const features = [
    { icon: '💬', title: 'Parent-Teacher Communication', description: 'Seamless messaging with SMS and WhatsApp integration via Africa\'s Talking' },
    { icon: '📊', title: 'Attendance Tracking', description: 'Easy attendance marking with instant notifications to parents' },
    { icon: '💰', title: 'Payment Management', description: 'Track payments and send reminders via multiple channels' },
    { icon: '👥', title: 'Multi-Role System', description: 'Support for superadmins, school admins, teachers, parents, and students' },
    { icon: '🏫', title: 'Multi-School Support', description: 'Manage multiple schools from a single platform with data isolation' },
    { icon: '📱', title: 'Mobile Optimized', description: 'Fully responsive design that works on all devices' }
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-x-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-40 right-10 w-72 h-72 bg-indigo-800 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-40 left-20 w-72 h-72 bg-emerald-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '4s' }}></div>
      </div>

      <Head>
        <title>Tuitora - Modern School Management Platform</title>
        <meta name="description" content="Multi-school EdTech platform for school management with communication, attendance tracking, and payment management" />
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                <Link href="/dashboard" className="bg-emerald-500 hover:bg-emerald-600 px-6 py-2 rounded-full font-medium transition-all duration-300 transform hover:scale-105 shadow-lg text-white">
                  Dashboard
                </Link>
              ) : (
                <>
                  <Link href="/login" className="hidden sm:block text-gray-200 hover:text-emerald-400 font-medium transition-colors duration-300">
                    Login
                  </Link>
                  <Link href="/signup" className="bg-emerald-500 hover:bg-emerald-600 px-6 py-2 rounded-full font-medium transition-all duration-300 transform hover:scale-105 shadow-lg text-white">
                    Sign Up
                  </Link>
                </>
              )}
            ...
            <div className="md:hidden mt-4 p-6 bg-gray-100/10 backdrop-blur-lg rounded-2xl border border-white/20 transition-all duration-300">
              <nav className="flex flex-col space-y-4" aria-label="Mobile navigation">
                ...
                <div className="border-t border-white/20 pt-4 space-y-3">
                  {user ? (
                    <Link href="/dashboard" className="block text-center bg-emerald-500 hover:bg-emerald-600 px-6 py-3 rounded-xl font-medium transition-all duration-300 text-white">
                      Dashboard
                    </Link>
                  ) : (
                    <>
                      <Link href="/login" className="block text-center text-gray-200 hover:text-emerald-400 font-medium transition-colors duration-300">
                        Login
                      </Link>
                      <Link href="/signup" className="block text-center bg-emerald-500 hover:bg-emerald-600 px-6 py-3 rounded-xl font-medium transition-all duration-300 text-white">
                        Sign Up
                      </Link>
                    </>
                  )}
      ...
      <main className="container mx-auto px-4 py-20 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="bg-gray-100/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-emerald-400/30 transition-all duration-300 transform hover:scale-105">
        ...
        {/* Enhanced School Search Section */}
        <section className="mb-20">
          <div className="bg-white/5 backdrop-blur-lg p-10 rounded-3xl border border-white/10">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="flex rounded-2xl overflow-hidden shadow-2xl">
                ...
                />
                <button className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 px-8 py-4 transition-all duration-300 font-medium">
                  Search
                </button>
              </div>
            </div>
        ...
        <section id="pricing" className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-3xl border border-white/10 hover:border-emerald-400/30 transition-all duration-300">
              ...
              <div className="text-5xl font-bold bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent mb-6">$0</div>
              ...
              <Link href="/signup" className="block w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-center py-3 rounded-xl transition-all duration-300 transform hover:scale-105 font-medium">
                Start Free
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 p-8 rounded-3xl transform scale-105 shadow-2xl relative overflow-hidden">
              ...
              <div className="text-5xl font-bold text-white mb-6">$99<span className="text-lg">/month</span></div>
              ...
              <Link href="/signup" className="block w-full bg-white text-emerald-600 text-center py-3 rounded-xl transition-all duration-300 hover:bg-gray-50 transform hover:scale-105 font-medium shadow-lg">
                Get Started
              </Link>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-3xl border border-white/10 hover:border-emerald-400/30 transition-all duration-300">
              ...
              <div className="text-5xl font-bold bg-gradient-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent mb-6">Custom</div>
              ...
              <Link href="#contact" className="block w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-center py-3 rounded-xl transition-all duration-300 transform hover:scale-105 font-medium">
                Contact Sales
              </Link>
            </div>
          </div>
        ...
        <section id="contact" className="text-center mb-20">
          <div className="bg-white/5 backdrop-blur-lg p-12 rounded-3xl border border-white/10">
            ...
            <Link 
              href="/signup" 
              className="inline-block bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 px-12 py-4 rounded-2xl text-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-emerald-500/25"
            >
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="space-y-3">
                <Link href="#features" className="block text-white/70 hover:text-emerald-300 transition-colors duration-300">Features</Link>
                <Link href="#pricing" className="block text-white/70 hover:text-emerald-300 transition-colors duration-300">Pricing</Link>
                <Link href="#contact" className="block text-white/70 hover:text-emerald-300 transition-colors duration-300">Demo</Link>
              </div>
            </div>
            <div>
              <h4 className="font-semibold text-white mb-6">Support</h4>
              <div className="space-y-3">
                <Link href="/help" className="block text-white/70 hover:text-emerald-300 transition-colors duration-300">Help Center</Link>
                <Link href="/contact" className="block text-white/70 hover:text-emerald-300 transition-colors duration-300">Contact</Link>
                <Link href="/faq" className="block text-white/70 hover:text-emerald-300 transition-colors duration-300">FAQ</Link>
              </div>
            </div>
            <div>
              <h4 className="font-semibold text-white mb-6">Legal</h4>
              <div className="space-y-3">
                <Link href="/privacy" className="block text-white/70 hover:text-emerald-300 transition-colors duration-300">Privacy Policy</Link>
                <Link href="/terms" className="block text-white/70 hover:text-emerald-300 transition-colors duration-300">Terms of Service</Link>
              </div>
            </div>
          </div>
