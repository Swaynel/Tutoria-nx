...
export default function LeftSidebar() {
  ...
  // Get dynamic badge color for role
  ...
  return (
    <div className={`${isCollapsed ? 'w-16' : 'w-72'} bg-indigo-900 text-white flex flex-col transition-all duration-300 ease-in-out shadow-2xl border-r border-white/10`}>
      {/* Header */}
